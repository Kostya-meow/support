...
def create_users_database():
    ...
    pages = [
        ('tickets', 'Заявки', 'Просмотр и управление заявками пользователей'),
        ('dashboard', 'Дашборд', 'Просмотр аналитики и статистики'),
        ('knowledge', 'База знаний', 'Управление базой знаний'),
        ('simulator', 'Симулятор', 'Доступ к симулятору обучения'),
        ('admin', 'Администрирование', 'Доступ к админ-панели (пользователи, роли, настройки)')
    ]
    ...
    settings = [
        ('registration_enabled', 'false', 'boolean', 'Разрешить регистрацию новых пользователей'),
        ...
        ('max_file_size_mb', '10', 'number', 'Максимальный размер загружаемых файлов (МБ)'),
